...
class GatedGaussianMargAmpPhase(BaseGatedGaussian):
    r"""Gated gaussian model with analytical marginalization over amplitude
     and phase.

    This implements the GatedGaussian likelihood with an analytical marginalization 
    over amplitude and phase.
    """
    name = 'gated_gaussian_margampphase'
